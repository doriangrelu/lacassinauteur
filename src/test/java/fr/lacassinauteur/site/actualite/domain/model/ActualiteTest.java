...
class ActualiteTest {
    ...
    void une_date_future_est_un_evenement_a_venir() {
        Actualite actualite = Actualite.creer("Salon du livre", "Texte", AUJOURDHUI.plusDays(10), "Paris", null, null, null, false, false);
    ...
    void une_date_passee_est_une_actualite_passee() {
        Actualite actualite = Actualite.creer("Salon du livre", "Texte", AUJOURDHUI.minusDays(10), "Paris", null, null, null, false, false);
    ...
    void larchivage_manuel_force_le_type_passee_meme_pour_une_date_future() {
        Actualite actualite = Actualite.creer("Événement annulé", "Texte", AUJOURDHUI.plusDays(10), "Paris", null, null, null, true, false);
    ...
    void les_champs_optionnels_vides_sont_normalises_en_null() {
        Actualite actualite = Actualite.creer("Titre", "", AUJOURDHUI, "", "", null, null, false, false);
