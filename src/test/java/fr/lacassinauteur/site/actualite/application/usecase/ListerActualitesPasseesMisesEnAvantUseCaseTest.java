...
class ListerActualitesPasseesMisesEnAvantUseCaseTest {
    ...
    void seules_les_actualites_passees_et_mises_en_avant_sont_listees() {
        ...
        Actualite misEnAvant = Actualite.creer("Passée mise en avant", "Texte", LocalDate.now().minusDays(10), "Paris", null, null, null, false, true);
        Actualite nonMisEnAvant = Actualite.creer("Passée discrète", "Texte", LocalDate.now().minusDays(5), "Lyon", null, null, null, false, false);
        Actualite aVenir = Actualite.creer("À venir", "Texte", LocalDate.now().plusDays(5), "Nice", null, null, null, false, true);
